...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let arrowUpwardAlt = ImageAsset(name: "arrow_upward_alt")
    internal static let bonusFakePage = ImageAsset(name: "bonus-fake-page")
    internal static let deutschlandCardTeaser = ImageAsset(name: "deutschland-card-teaser")
    internal static let localGasStation = ImageAsset(name: "local_gas_station")
